...
2026-09-15 新增的聊天随笔在撤下一篇后保留 18 篇，加上原有的《现在的小霸王》，目前共 19 篇。每篇使用独立 Markdown 文件和可分享链接，已补充日常、运动、音乐、阅读、语言、电影、技术、观察标签。
...
`tests/essays.test.mjs` 验证这批文章的正文、路由、日期、同日排序、列表和 RSS 数量，以及目录和资料链接。
